...
all_words = [word for word in all_words if word not in stopwords_set]

final_all_characters_words = {
    "all": Counter(all_words).most_common(10),
}
...
show_graphic(final_all_characters_words, "Mots les plus utilisés de tous les personnages")